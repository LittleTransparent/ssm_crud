		...
		<div class="row">
			<div class="col-md-12">
				<table class="table table-hover" id="emps_table">
					...
					<tbody>
						<!-- 添加build_emps_table(result)中定义的表格 -->
					</tbody>
				</table>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function to_page(pn) {
			$.ajax({
				...
				data : "pn=" + pn,
				type : "GET",
				//上面拿到了emps/pn=1的资源，按f12可看到此请求，下面解析此请求内的json数据
				...
				function(index, item) {
					...
					*/
					var editBtn = $("<button></button>")
							.addClass("btn btn-primary btn-sm edit_btn").append($("<span></span>")
							.addClass("glyphicon glyphicon-pencil")).append("编辑");
					//为编辑按钮添加一个自定义的属性，来表示当前员工id
					editBtn.attr("edit-id", item.empId);
					//删除按钮
					var delBtn = $("<button></button>")
							.addClass("btn btn-danger btn-sm delete_btn").append($("<span></span>")
